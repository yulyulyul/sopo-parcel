...
import team.sopo.infrastructure.parcel.tracker.sopo.SopoTrackerClient

@Component
class SopoTrackerSearchApiCaller(
    private val client: SopoTrackerClient,
    ...
    override fun support(searchMethod: SearchMethod): Boolean {
        return searchMethod == SearchMethod.SopoTracker
    }
